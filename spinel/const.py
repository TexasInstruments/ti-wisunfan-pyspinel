...
class SPINEL(object):
    ...
    PROP_PHY_REGULATORY_CHANNEL_LIST = PROP_WISUN__BEGIN + 5 # < [D]
    PROP_PHY_OPERATING_CLASS = PROP_WISUN__BEGIN + 6 # < [C]
    PROP_PHY_TOTAL_NUMBER_CHANNEL = PROP_WISUN__BEGIN + 7 # < [C]
    ...
    PROP_EXTERNAL_DHCP_SERVER_ENABLED = PROP_WISUN_EXT__BEGIN + 96,
    PROP_EXTERNAL_AUTH_SERVER_ENABLED = PROP_WISUN_EXT__BEGIN + 97,
    PROP_EXTERNAL_AUTH_SERVER_ADDRESS = PROP_WISUN_EXT__BEGIN + 98,
    PROP_EXTERNAL_DHCP_SERVER_ADDRESS = PROP_WISUN_EXT__BEGIN + 99,
    PROP_DISABLENSMESSAGES_COMMAND = PROP_WISUN_EXT__BEGIN + 100   # < [b]
